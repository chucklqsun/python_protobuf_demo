...
# source: proto/common/error_code.proto
...
_STATUSPB = _descriptor.Descriptor(
  name='StatusPb',
  full_name='proto.common.StatusPb',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error_code', full_name='proto.common.StatusPb.error_code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='msg', full_name='proto.common.StatusPb.msg', index=1,
...
StatusPb = _reflection.GeneratedProtocolMessageType('StatusPb', (_message.Message,), dict(
  ...
  __module__ = 'proto.common.error_code_pb2'
  # @@protoc_insertion_point(class_scope:proto.common.StatusPb)
  ))
